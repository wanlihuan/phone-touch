...
public class IconUtilities {
    ...
    public IconUtilities(Context context) {
        ...
        final float blurPx = 12 * density;

        mIconWidth = mIconHeight = (int) resources.getDimension(R.dimen.app_icon_size);
       ...
       // TypedValue value = new TypedValue();
        mGlowColorPressedPaint.setColor(/*context.getTheme().resolveAttribute(
                android.R.attr.colorPressedHighlight, value, true) ? value.data : */0xff007f00);
