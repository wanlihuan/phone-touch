...
public class PreferenceCheckBoxView extends FrameLayout{
	...
	public PreferenceCheckBoxView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public PreferenceCheckBoxView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
		
		LayoutInflater inflater = LayoutInflater.from(context);
		inflater.inflate(R.layout.preference_item_checkbox_layout, this, true);
		...
		mSlipButton = (SlipButton) this.findViewById(R.id.checkbox);
		mDividerBottomView = this.findViewById(R.id.divider_bottom);
	}
	
	public void setOnCheckedSlipButtonChangeListener(OnCheckedChangeListener onCheckedChangeListener){
		mSlipButton.setOnCheckedChangeListener(onCheckedChangeListener);
	}
	
	public void setCheckedSlipButton(boolean checked){
		mSlipButton.setChecked(checked);
	}
